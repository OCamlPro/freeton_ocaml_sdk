...
If :code:`freeton_ocaml_sdk` is available in your opam repository, you can just call::

  opam install freeton_ocaml_sdk

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`freeton_ocaml_sdk` in a directory.
